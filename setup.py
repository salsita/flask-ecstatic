...
from flask_ecstatic import __version__, __doc__
...
properties = dict(
    name = 'Flask-Ecstatic',
    version = __version__,
    url = 'https://github.com/salsita/flask-ecstatic',
    download_url = 'https://github.com/salsita/flask-ecstatic/tarball/v{}'.format( __version__),
